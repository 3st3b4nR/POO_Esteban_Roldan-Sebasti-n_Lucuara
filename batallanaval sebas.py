        ...
        if self.estado == "colocando":
            if self.turno == tablero_id:
                if self.tableros[self.turno].colocar_barco(fila, col):
                    self.botones[self.turno][fila][col].config(text="🚢", bg="green")
            ...
            if tablero_id == enemigo and (fila, col) not in self.tableros[enemigo].disparos:
                ...
                if resultado == "tocado":
                    self.botones[enemigo][fila][col].config(text="💥", bg="red")
                else:
                    self.botones[enemigo][fila][col].config(text=" ", bg="gray")
